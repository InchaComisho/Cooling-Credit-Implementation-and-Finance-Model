...
このページは、帳簿上の相殺価値と、測定された物理的冷却・保水・蒸散・腐葉土化・山林再生・EEZ海洋冷却・沿岸砂漠外輪再生・災害圧力低減・地域経済共便益に基づくクーリングクレジット・シナリオを比較する概念シミュレーション結果である。
...
**統合自然フィードバック**シナリオが最も高い総合クーリングクレジット価値を示した。これは、都市冷却、腐葉土化、森林再生、海洋循環、砂漠外輪再生、MRV信頼度、生態安全性、地域参加が相互に強化されるためである。

**沿岸・砂漠外輪再生**シナリオは、沿岸淡水化、UMS冷却、腐葉土・微生物定着、外輪植生回復、ピラミッド型太陽光・垂直風力・地下居住効率といった砂漠特化指標で強い。

**EEZ海洋冷却**シナリオは、海面冷却、溶存酸素回復、海洋食物網回復、漁業・観光共便益といった海洋特化指標で最も強い。

**帳簿上の相殺のみ**のシナリオでは、会計上の価値は増加し得るが、この概念モデル上では、物理的冷却、保水、蒸散回復、海洋回復、砂漠外輪再生、災害圧力低減は発生しない。

---

## 最終年サマリー

| シナリオ | クーリングクレジット価値 | 物理冷却 | 保水 | 蒸散 | 海面冷却 | 溶存酸素 | 海洋食物網 | 砂漠地表冷却 | 砂漠水供給 | 腐植定着 | 砂漠植生 | 砂漠エネルギー・地下 | 災害圧力低減 | 地域共便益 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
...
- [砂漠シナリオ入り最終年サマリーCSV](outputs/natural_feedback_cooling_final_year_summary_with_desert.csv)
...
これは概念的な決定論モデルであり、気象予測、水文予測、作物予測、漁業予測、災害予測、投資助言ではない。政策、補助金、保険、投資に使う場合は、地域の実測データ、生態安全評価、衛生検査、停止条件、独立MRVで前提値を置き換える必要がある。
